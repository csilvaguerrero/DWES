...
class ModeloRetos{
    ...
    public function listarRetos(){
        ...
        $sql = "SELECT * FROM Retos WHERE idProfesor = ?";
    ...
    public function anadirReto($parametro){
        ...
        $parametro["idProfesor"] = $_SESSION["id"]["id"];
    ...
    public function sacarNombreReto($id){
        ...
        $sql = "SELECT nombre FROM Retos WHERE id = ?";
    ...
    public function sacarFilaReto($id){
        ...
        $sql = "SELECT * FROM Retos WHERE id = ?";
    ...
    public function actualizarReto($id, $array){
        ...
        $array["idProfesor"] = $_SESSION["id"]["id"];
    ...
    public function sacarCategoria($idCategoria){
        ...
        $prepare->bind_param("i", $idCategoria);
    ...
    public function sacarProfesor($idProfesor){
        ...
        $prepare->bind_param("i", $idProfesor);
